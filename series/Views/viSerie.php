...
<body>
  ...
  <table class="container table table-striped table-responsive table-bordered border-dark mt-3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class='text-danger font-weight-bold font-italic'>
          <?php echo "no emitiéndose" ?>
        </td>
        ...
        <td class="text-center text-darkblue">
          <a href="info.php?serie=<?php echo $array ?>&argumento=<?php echo $serie["argumento"] ?>">+ info</a>
        </td>
